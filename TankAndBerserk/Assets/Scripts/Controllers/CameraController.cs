...
public class CameraController : MonoBehaviour
{
    ...
    private void FixedUpdate() //활성화 플레이어 위치로 카메라 이동
    {
        TargetPos = new Vector3(PlayerChoice.Player.transform.position.x + offsetX,
                                PlayerChoice.Player.transform.position.y + offsetY,
                                PlayerChoice.Player.transform.position.z + offsetZ);
